...
import { FileText, RefreshCcw, LayoutDashboard } from "lucide-react";
...
export default function SalesError({
    ...
    useEffect(() => {
        logger.log(error, { componentName: "SalesRouteError", route: "/sales" });
    }, [error]);
    ...
    return (
        <div className="flex min-h-[400px] flex-col items-center justify-center rounded-2xl border border-red-100 bg-white p-12 text-center shadow-sm dark:border-red-900/20 dark:bg-gray-900">
            ...
            <p className="mb-8 max-w-md text-gray-600 dark:text-gray-400">
                There was an error loading the sales history. Please try refreshing or check your filters.
            </p>
